...
On the SDK, this functionality is provided by the[`SimApp`](https://github.com/evdatsion/cosmos-sdk/blob/master/simapp/app.go), which is a
`Baseapp` application that is used for running the [`simulation`](https://github.com/evdatsion/cosmos-sdk/tree/master/x/simulation) module.
...
Check the full list of flags [here](https://github.com/evdatsion/cosmos-sdk/blob/adf6ddd4a807c8363e33083a3281f6a5e112ab89/simapp/sim_test.go#L34-L50).
...
The list of available parameters are listed [here](https://github.com/evdatsion/cosmos-sdk/blob/adf6ddd4a807c8363e33083a3281f6a5e112ab89/x/simulation/params.go#L170-L178).
...
check the SDK [Makefile](https://github.com/evdatsion/cosmos-sdk/blob/adf6ddd4a807c8363e33083a3281f6a5e112ab89/Makefile#L88-L123).

```bash
 $ go test -mod=readonly github.com/evdatsion/cosmos-sdk/simapp \
...
[Logger](https://github.com/evdatsion/cosmos-sdk/blob/adf6ddd4a807c8363e33083a3281f6a5e112ab89/x/staking/keeper/keeper.go#L65:17) on your `Keeper`.
