...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/x/bank/types/tx.pb.go#L285-L291
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc1/x/bank/keeper/msg_server.go#L14-L16

`msgServer` methods can retrieve the `sdk.Context` from the `context.Context` parameter method using the `sdk.UnwrapSDKContext`:

+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc1/x/bank/keeper/msg_server.go#L27
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc2/baseapp/msg_service_router.go#L104
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/d55c1a26657a0af937fa2273b38dcfa1bb3cff9f/proto/cosmos/base/abci/v1beta1/abci.proto#L81-L95
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc2/types/handler.go#L4
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/228728cce2af8d494c8b4e996d011492139b04ab/x/gov/module.go#L143-L146

### Implementation

`NewHandler` function dispatches a `Msg` to appropriate handler function, usually by using a switch statement:

+++ https://github.com/evdatsion/cosmos-sdk/blob/d55c1a26657a0af937fa2273b38dcfa1bb3cff9f/x/bank/handler.go#L13-L29
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc1/x/auth/vesting/msg_server.go#L73-L85
