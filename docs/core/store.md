...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/types/store.go#L15-L18
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/types/store.go#L240-L264
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/types/store.go#L29-L33

The `Committer` is an interface that defines methods to persist changes to disk:

+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/types/store.go#L20-L27
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/types/store.go#L104-L133
...
+++https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/types/store.go#L141-L184

As for concrete implementation, the [`rootMulti.Store`] is the go-to implementation of the `CommitMultiStore` interface.

+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/rootmulti/store.go#L43-L61
...
Whenever the `rootMulti.Store` needs to be cached-wrapped, a [`cachemulti.Store`](https://github.com/evdatsion/cosmos-sdk/blob/master/store/cachemulti/store.go) is used.

+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/cachemulti/store.go#L17-L28
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/types/store.go#L189-L219
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/x/bank/keeper/view.go#L115-L134

### `IAVL` Store

The default implementation of `KVStore` and `CommitKVStore` used in `baseapp` is the `iavl.Store`.

+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/iavl/store.go#L37-L40
...
The documentation on the IAVL Tree is located [here](https://github.com/evdatsion/iavl/blob/v0.15.0-rc5/docs/overview.md).

### `DbAdapter` Store

`dbadapter.Store` is a adapter for `dbm.DB` making it fulfilling the `KVStore` interface.

+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/dbadapter/store.go#L13-L16
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/transient/store.go#L13-L16
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/x/params/types/subspace.go#L20-L30

Transient stores are typically accessed via the [`context`](./context.md) via the `TransientStore()` method:

+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/types/context.go#L232-L235
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/cachekv/store.go#L27-L34
...
Cosmos SDK applications use [`gas`](../basics/gas-fees.md) to track resources usage and prevent spam. [`GasKv.Store`](https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/gaskv/store.go) is a `KVStore` wrapper that enables automatic gas consumption each time a read or write to the store is made. It is the solution of choice to track storage usage in Cosmos SDK applications.

+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/gaskv/store.go#L13-L19
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/types/gas.go#L153-L162
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/types/context.go#L227-L230

In this case, the default gas configuration is used:

+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/types/gas.go#L164-L175
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/tracekv/store.go#L20-L43
...
+++ https://github.com/evdatsion/cosmos-sdk/blob/v0.40.0-rc3/store/prefix/store.go#L15-L21
