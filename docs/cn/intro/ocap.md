...
在 Cosmos SDK 中，你可以看到[gaia app](https://github.com/evdatsion/cosmos-sdk/blob/master/simapp/app.go)中对该原则的实践。

+++ https://github.com/evdatsion/gaia/blob/master/app/app.go#L197-L209
