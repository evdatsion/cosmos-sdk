...
- `intro`: Introductory material. Goal is to have a short explainer of the SDK and then channel people to the resource they need. The [sdk-tutorial](https://github.com/evdatsion/sdk-application-tutorial/) will be highlighted, as well as the `godocs`.
...
- Will help build an executable doc (cf https://github.com/evdatsion/cosmos-sdk/issues/2611)
...
- https://github.com/evdatsion/cosmos-sdk/issues/1460
- https://github.com/evdatsion/cosmos-sdk/pull/2695
- https://github.com/evdatsion/cosmos-sdk/issues/2611
