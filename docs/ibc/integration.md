...
module](https://github.com/evdatsion/cosmos-sdk/tree/master/x/ibc) to your Cosmos SDK application and
...
by the port
[`Router`](https://github.com/evdatsion/cosmos-sdk/tree/master/x/ibc//core/05-port/types/router.go) on the
IBC module.
...
misbehaviour](https://github.com/evdatsion/ics/tree/master/spec/ics-002-client-semantics#misbehaviour)
...
[`BeginBlock`](https://github.com/evdatsion/cosmos-sdk/blob/master/x/ibc/core/02-client/abci.go) logic as
well. This is optional as it is only required if your application uses the [localhost
client](https://github.com/evdatsion/ics/blob/master/spec/ics-009-loopback-client) to connect two
...
[`SimApp`](https://github.com/evdatsion/cosmos-sdk/blob/master/simapp/app.go).
