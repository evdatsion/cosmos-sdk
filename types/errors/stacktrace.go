...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/evdatsion/cosmos-sdk/types/errors.Wrap",
		"github.com/evdatsion/cosmos-sdk/types/errors.Wrapf",
		"github.com/evdatsion/cosmos-sdk/types/errors.WithType",
