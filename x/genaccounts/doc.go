...
The ADR can be found here: https://github.com/evdatsion/cosmos-sdk/blob/master/docs/architecture/adr-011-generalize-genesis-accounts.md.
...
refer to https://github.com/evdatsion/gaia/pull/122.
*/
package genaccounts
