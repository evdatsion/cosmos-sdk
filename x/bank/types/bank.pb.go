...
type Supply struct {
	Total github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=total,proto3,castrepeated=github.com/evdatsion/cosmos-sdk/types.Coins" json:"total"`
}
