...
type QueryDelegationTotalRewardsResponse struct {
	...
	Total github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=total,proto3,castrepeated=github.com/evdatsion/cosmos-sdk/types.DecCoins" json:"total"`
}
...
type QueryCommunityPoolResponse struct {
	...
	Pool github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=pool,proto3,castrepeated=github.com/evdatsion/cosmos-sdk/types.DecCoins" json:"pool"`
}
