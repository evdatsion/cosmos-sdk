...
type GenesisState struct {
	...
	LastTotalPower github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=last_total_power,json=lastTotalPower,proto3,customtype=github.com/evdatsion/cosmos-sdk/types.Int" json:"last_total_power" yaml:"last_total_power"`
