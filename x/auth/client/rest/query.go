...
import (
	...
	clientrest "github.com/evdatsion/cosmos-sdk/client/rest"
	...
	genutilrest "github.com/evdatsion/cosmos-sdk/x/genutil/client/rest"
)
...
func QueryAccountRequestHandlerFn(storeName string, clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			...
			// Ref: https://github.com/evdatsion/cosmos-sdk/issues/4923
